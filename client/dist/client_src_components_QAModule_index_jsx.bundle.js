...
/* harmony import */ var _Modals_ModalTest__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../Modals/ModalTest */ "./client/src/components/Modals/ModalTest.jsx");
...
var AddAnswerButton = styled_components__WEBPACK_IMPORTED_MODULE_2__["default"].button(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  font-size: 11px;\n  font-weight: 400;\n  color: gray;\n  text-decoration: underline;\n  background-color: transparent;\n  border: none;\n  padding: 8px;\n  cursor: pointer;\n  transition: all 0.3s ease;\n\n  &:hover {\n    color: #404040;\n  }\n"])));
var FormContainer = styled_components__WEBPACK_IMPORTED_MODULE_2__["default"].div(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n"])));
var Label = styled_components__WEBPACK_IMPORTED_MODULE_2__["default"].label(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n  font-weight: bold;\n  margin: 8px 150px 8px 0px;\n"])));
var TextArea = styled_components__WEBPACK_IMPORTED_MODULE_2__["default"].textarea(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n  resize: none;\n  width: 75%;\n  margin-top: 4px;\n  padding: 8px;\n  border: 1px solid #ccc;\n  border-radius: 4px;\n"])));
var Input = styled_components__WEBPACK_IMPORTED_MODULE_2__["default"].input(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n  margin-top: 4px;\n  padding: 2px 8px 2px 8px;\n  border: 1px solid #ccc;\n  border-radius: 4px;\n"])));
var SmallText = styled_components__WEBPACK_IMPORTED_MODULE_2__["default"].p(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["\n  font-size: 12px;\n  color: #777;\n  margin-top: 4px;\n"])));
var SubmitButton = styled_components__WEBPACK_IMPORTED_MODULE_2__["default"].button(_templateObject7 || (_templateObject7 = _taggedTemplateLiteral(["\n  margin-top: 12px;\n  padding: 8px 16px;\n  background-color: #5a5a5a;\n  color: white;\n  font-weight: bold;\n  border: none;\n  border-radius: 4px;\n  cursor: pointer;\n  transition: background-color 0.3s;\n\n  &:hover {\n    background-color: #404040;\n  }\n"])));
function AddAnswer(_ref) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.prev = 1;
            _context.next = 4;
            return axios__WEBPACK_IMPORTED_MODULE_3__["default"].post("https://app-hrsei-api.herokuapp.com/api/fec2/hr-rfp/qa/questions/".concat(question.question_id, "/answers"), {
              body: answerText,
              name: nickname,
              email: email
            }, {
  ...
  }, "Add Answer"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_Modals_ModalTest__WEBPACK_IMPORTED_MODULE_1__["default"], {
    isOpen: isModalOpen,
    onClose: closeModal,
    "data-testid": "modal-test"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h2", null, "Submit Your Answer"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h4", null, "[PRODUCT NAME HERE ID: [".concat(question.question_body, "]")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("form", {
...
var AddQuestionButton = styled_components__WEBPACK_IMPORTED_MODULE_2__["default"].button(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  background: transparent;\n  border: 1px solid;\n  margin: 10px 0px 10px 0px;\n  padding: 16px 14px;\n  font-size: 15px;\n  cursor: pointer;\n\n  &:hover {\n    color: #333333;\n  }\n"])));
var Form = styled_components__WEBPACK_IMPORTED_MODULE_2__["default"].form(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n"])));
var Label = styled_components__WEBPACK_IMPORTED_MODULE_2__["default"].label(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n  font-weight: bold;\n  margin: 8px 150px 8px 0px;\n"])));
var TextArea = styled_components__WEBPACK_IMPORTED_MODULE_2__["default"].textarea(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n  resize: none;\n  width: 75%;\n  margin-top: 4px;\n  padding: 8px;\n  border: 1px solid #ccc;\n  border-radius: 4px;\n"])));
var Input = styled_components__WEBPACK_IMPORTED_MODULE_2__["default"].input(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n  margin-top: 4px;\n  padding: 2px 8px 2px 8px;\n  border: 1px solid #ccc;\n  border-radius: 4px;\n"])));
var SmallText = styled_components__WEBPACK_IMPORTED_MODULE_2__["default"].p(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["\n  font-size: 12px;\n  color: #777;\n  margin-top: 4px;\n"])));
...
function AddQuestion(_ref) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.prev = 1;
            _context.next = 4;
            return axios__WEBPACK_IMPORTED_MODULE_3__["default"].post('https://app-hrsei-api.herokuapp.com/api/fec2/hr-rfp/qa/questions', {
              body: questionText,
              name: nickname,
              email: email,
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(AddQuestionButton, {
    type: "button",
    onClick: openModal
  }, "ADD A QUESTION +"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_Modals_ModalTest__WEBPACK_IMPORTED_MODULE_1__["default"], {
    isOpen: isModalOpen,
    onClose: closeModal
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h2", null, "Ask Your Question"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h4", null, "About the [PRODUCT NAME HERE ID: ".concat(productId, "]")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(Form, {
    onSubmit: handleSubmit
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(Label, {
